...
export const SlideStyling: React.FC<SlideStylingProps> = ({
  slide,
  index,
  onUpdate,
  onUpdateContent,
    ...
    <Stack spacing={3}>
      <Grid container spacing={2}>
        <Grid size={{ xs: 12, sm: 6 }}>
          <TextField
            ...
            onChange={(e) => onUpdate(index, { backgroundColor: e.target.value })}
            placeholder="#ffffff"
            InputProps={{
              startAdornment: (
                <IconButton size="small">
                  <ColorLens sx={{ color: slide.backgroundColor || 'action.active' }} />
                </IconButton>
              ),
            }}
          />
        ...
        <Grid size={{ xs: 12, sm: 6 }}>
          <TextField
            ...
            onChange={(e) => onUpdate(index, { backgroundImage: e.target.value })}
            InputProps={{
      ...
      <Box>
        ...
        <RadioGroup
          ...
          onChange={(e) => onUpdateContent(index, { alignment: e.target.value as 'left' | 'center' | 'right' })}
        >
