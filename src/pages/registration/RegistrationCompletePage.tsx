...
import { clearStoredPlan } from "../../utils/planStorage";
...
export const RegistrationCompletePage: React.FC = () => {
  ...
  useEffect(() => {
    ...
    const cleanupTimer = setTimeout(() => {
      ...
      clearStoredPlan(); // Clean up the pre-selected plan
    }, 5000);
              ...
              >
                <Box
                  sx={{
                    ...
                    borderRadius: "50%",
                    background:
                      "linear-gradient(135deg, #483C32 0%, #00D4AA 100%)",
                    display: "flex",
                    alignItems: "center",
                ...
                <Stack spacing={3}>
                  ...
                  <Paper
                    sx={{
                      p: 3,
                      background:
                        "linear-gradient(135deg, #5C633A15 0%, #D4BC8C15 100%)",
                      border: "1px solid",
